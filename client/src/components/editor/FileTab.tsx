        ...
        >
            {openFiles.map((file) => (
                <span
                    key={file.id}
                    className={cn(
                        "flex w-fit cursor-pointer items-center rounded-t-md px-2 py-1 text-text",
                        { "bg-surfaceHover": file.id === activeFile?.id },
                    )}
                ...
                >
                    ...
                    <IoClose
                        className="ml-3 inline rounded-lg hover:bg-surfaceHover"
                        size={20}
