        ...
        <div onClick={handleClickOutside} className="flex flex-grow flex-col">
            <div className="view-title flex justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        className="rounded-lg px-1 hover:bg-surfaceHover"
...
function Directory({
    ...
    return (
        <div className="overflow-x-auto">
            <div
                className="flex w-full items-center rounded-lg px-2 py-1 hover:bg-surfaceHover"
...
const FileMenu = ({
    ...
    return (
        <div
            className="absolute z-10 w-[150px] rounded-lg border border-border bg-surface p-1"
            style={{
                top,
                left,
            }}
        >
            <button
                ...
                className="flex w-full items-center gap-2 rounded-lg px-2 py-1 hover:bg-surfaceHover"
            >
            ...
            <button
                ...
                className="flex w-full items-center gap-2 rounded-lg px-2 py-1 text-danger hover:bg-surfaceHover"
            >
                <MdDelete size={20} />
                Delete
            </button>
