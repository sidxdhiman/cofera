    ...
    return (
        <div className="rounded-lg">
            ...
            >
                <input
                    type="text"
                    className="w-full flex-grow rounded-sm bg-surface px-2 text-base text-text outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                    autoFocus
                    value={name}
